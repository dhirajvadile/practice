--create table client_master(client_no int,name varchar(20),city varchar(10),pincode int,state varchar(10),Baldue int);
 

--create table product_master(pro_no int, Desc_ription varchar(10) ,profit_percent int,unit_measure varchar(10), qty_on_hand int, recordLv1 int, sell_price int, cost_price int);

create table salesman_master(salesman_no varchar(20),sal_name varchar(10),add1 varchar(15),add2 varchar(15),city varchar(10),pincode int,state_name varchar(15),salAmt int,TgtToGet int,YtdSales int,Remarks varchar(20));

--insert into client_master values(0001,'Ivan Byroos','Mumbai',400054,'maharashtr',15000);
...
--insert into client_master values(0005,'Hansel Calaco','Mumbai',400060,'maharashtr',2000);
--insert into client_master values(0006,'Deepak Sharma','Manglore',560050,'karnataka',0);

-- --table two

--insert into product_master values(0001,'T-shirt',5,'piece',200,50,350,250);
--insert into product_master values(0345,'shirt',6,'piece',150,50,500,350);
--insert into product_master values(06734,'cotton jeans',5,'piece',100,20,600,450);
--insert into product_master values(07865,'jeans',5,'piece',100,20,750,500);
--insert into product_master values(07855,'trousers',2,'piece',150,50,850,550);
--insert into product_master values(07868,'Pull Overs',25,'piece',80,30,700,450);

insert into salesman_master values(00001,'Aman','A/14','Worli','Mumbai',400002,'Maharashtra',3000,100,50,'Good');
insert into salesman_master values(00002,'Omkar',65,'Nariman','Mumbai',400001,'Maharashtra',3000,200,100,'Good');
insert into salesman_master values(00003,'Raj','p-7','Bandra','Mumbai',400032,'Maharashtra',3000,200,100,'Good');
insert into salesman_master values(00004,'Ashish','A/5','Juhu','Mumbai',400044,'Maharashtra',3500,200,150,'Good');
